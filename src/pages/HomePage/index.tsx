  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] text-center">
      ...
      <p className="text-lg text-muted-foreground max-w-lg mb-12">
        A comprehensive platform for managing presentations and events for AWS organizers.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-card rounded-lg p-6 shadow-sm border border-border flex flex-col items-center text-center">
          ...
          <p className="text-muted-foreground mb-6">Submit presentations with all required information.</p>
        ...
        <div className="bg-card rounded-lg p-6 shadow-sm border border-border flex flex-col items-center text-center">
          ...
          <p className="text-muted-foreground mb-6">Create and edit presentation cover images.</p>
        ...
        <div className="bg-card rounded-lg p-6 shadow-sm border border-border flex flex-col items-center text-center">
          ...
          <p className="text-muted-foreground mb-6">Review and manage presentation submissions.</p>
